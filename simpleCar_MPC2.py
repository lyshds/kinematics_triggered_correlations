...
from agents.navigation.curvature_mpc_controller import *
    ...
    try:
        ...
        with CarlaSyncMode(world, camera, fps=30) as sync_mode:
            while True:
                ...
                col = ['timestamp', 'X', 'Y', 'PSI', 'Velocity', 'Xi', 'Eta', 'Theta', 'u_acceleration', 'u_steering_angle', 'pred_states', 'pred_control', 'computation_time', "kappa", "curvature_radius"]
